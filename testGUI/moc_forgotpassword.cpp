...
#include "../Qt_LinuxPrototypeGUI_v0.9/forgotpassword.h"
...
constexpr auto qt_meta_stringdata_CLASSforgotPasswordENDCLASS = QtMocHelpers::stringData(
    "forgotPassword",
    "on_pushButton_forgotCancel_clicked",
    "",
    "on_pushButton_forgotConfirm_clicked"
);
...
Q_CONSTINIT const QMetaObject forgotPassword::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSforgotPasswordENDCLASS_t,
        ...
        // method 'on_pushButton_forgotCancel_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_pushButton_forgotConfirm_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void forgotPassword::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_pushButton_forgotCancel_clicked(); break;
        case 1: _t->on_pushButton_forgotConfirm_clicked(); break;
        default: ;
        }
    }
    (void)_a;
