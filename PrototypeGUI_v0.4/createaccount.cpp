...
void createAccount::on_pushButton_createConfirm_clicked()
{
    ...
    } else if (ui->lineEdit_accountNewEmail->text().contains("@gmail.com") == 0)
    {
    ...
    {
        QMessageBox::information(this, "Account Created", "Your account was created. Check your email for a verification link.");
        close();
